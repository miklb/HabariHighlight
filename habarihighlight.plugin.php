...
class HabariHighlight extends Plugin {
	public function action_template_header() {
		Stack::add('template_stylesheet', '//cdnjs.cloudflare.com/ajax/libs/highlight.js/8.4/styles/'.Options::get('habarihighlight_theme').'.min.css', 'highlight');
		Stack::add('template_footer_javascript', '//cdnjs.cloudflare.com/ajax/libs/highlight.js/8.4/highlight.min.js', 'highlightjs');
